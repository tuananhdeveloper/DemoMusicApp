...
import com.tuananh.app.musicapp.ui.presenter.MainPresenterImpl
import com.tuananh.app.musicapp.util.Converter

class MainActivity : AppCompatActivity(), MainView, SeekBar.OnSeekBarChangeListener, View.OnClickListener,
MusicNotification.OnItemClickListener {
    ...
    override fun setSongs(songs: MutableList<Song>) {
        ...
        songAdapter.setOnItemClickListener { view, i ->
            playMusic(songs[i])
            showBottomSheet(songs[i])
        }
    }
    ...
    private fun registerBroadcastReceiver() {
        ...
        intentFilter.addAction(MusicNotification.ACTION_NEXT_MUSIC)
        intentFilter.addAction(MusicNotification.ACTION_PREVIOUS_MUSIC)
        intentFilter.addAction(MusicNotification.ACTION_PLAY_MUSIC)
